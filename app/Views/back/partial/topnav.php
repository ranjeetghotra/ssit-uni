      ...
      <ul class="navbar-nav align-items-center  ml-auto ml-md-0 ">
        <li class="nav-item dropdown">
          <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <div class="media align-items-center">
              <span class="avatar avatar-sm rounded-circle">
                <img alt="Image placeholder" src="/images/admin/user.jpg">
              </span>
          ...
          <div class="dropdown-menu  dropdown-menu-right ">
            ...
            <a href="/manage/admin" class="dropdown-item" data-toggle="modal" data-target="#passwordModal">
            ...
            <a href="/manage/logout" class="dropdown-item">
...
<div class="modal fade" id="passwordModal" tabindex="-1" role="dialog" aria-labelledby="modal-form" aria-hidden="true">
